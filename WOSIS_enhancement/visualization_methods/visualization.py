...
def create_simplified_visualization(df, output_path, title="WOSIS Original Dataset"):
    """
...
def main():
    ...
    # Dataset path
    dataset_path = f"/root/WOSIS_enhancement/data/backup_original/{name}.csv"
    #dataset_path="visualizations/WOSIS_30_60cm_samples_1000_modified.csv"
    ...
    print("\n🎨 CREATING SIMPLIFIED VISUALIZATION...")
    main_output = f"visualizations/{name}.png"
    result = create_simplified_visualization(df, main_output, f"{name} Original Dataset")
